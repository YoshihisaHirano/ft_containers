...
//		std::cout << "vec_fill:";
//		for (unsigned i=0; i<vec_fill.size(); i++)
//			std::cout << " " << vec_fill[i];
//		std::cout << std::endl;
//		ft::vector<int> vec(vec_fill.begin(), vec_fill.end());
//		std::cout << "vec: ";
//		for (unsigned i=0; i<vec.size(); i++)
//			std::cout << " " << vec[i];
//		std::cout << std::endl << vec.size() << " - size, " << vec.capacity() << " - capacity ";
//		std::cout << std::endl;
//	}
//	{
//		ft::vector<int> myvect(10);
//		for (int i= 0; i < 10; i++)
//			myvect[i] = i;
//		std::vector<int> thevect(10);
//		for (int i= 0; i < 10; i++)
//			thevect[i] = i;
//
//		ft::vector<int>::reverse_iterator frt = myvect.rbegin();
//		std::vector<int>::reverse_iterator srt = thevect.rbegin();
//		std::cout << *frt << " " << *srt << std::endl;
//		frt++; srt++;
//		std::cout << *frt << " " << *srt << std::endl;
//		frt++; srt++;
//		std::cout << *frt << " " << *srt << std::endl;
...
//		std::cout << std::boolalpha;
//		std::cout << (frt > myvect.rbegin()) << " " << (srt > thevect.rbegin()) << std::endl;
//		std::cout << (frt > myvect.rend()) << " " << (srt > thevect.rend()) << std::endl;
//		std::cout << (frt <= myvect.rbegin()) << " " << (srt <= thevect.rbegin()) << std::endl;
//		std::cout << (frt >= myvect.rend()) << " " << (srt >= thevect.rend()) << std::endl;
//		std::cout << (frt < myvect.rend()) << " " << (srt < thevect.rend()) << std::endl;
//		std::cout << *(myvect.rbegin() + 1) << " ";
//		std::cout << *(myvect.rbegin() + 2) << " ";
//		std::cout << *(myvect.rbegin() + 3) << " ";
//		std::cout << *(myvect.rbegin() + 4) << " ";
//		std::cout << *(myvect.rbegin() + 5) << " ";
//		std::cout << *(myvect.rbegin() - 1) << std::endl;
//		std::cout << myvect.rbegin()[1] << " ";
//		std::cout << myvect.rbegin()[2] << " ";
//		std::cout << myvect.rbegin()[3] << " ";
//		std::cout << myvect.rbegin()[4] << " ";
//		std::cout << myvect.rbegin()[5] << std::endl;
//		std::cout << "__________" << std::endl;


//		std::cout << *(thevect.rbegin() + 1) << " ";
//		std::cout << *(thevect.rbegin() + 2) << " ";
//		std::cout << *(thevect.rbegin() + 3) << " ";
//		std::cout << *(thevect.rbegin() + 4) << " ";
//		std::cout << *(thevect.rbegin() + 5) << " ";
//		std::cout << *(thevect.rbegin() - 1) << std::endl;
//		std::cout << thevect.rbegin()[1] << " ";
//		std::cout << thevect.rbegin()[2] << " ";
//		std::cout << thevect.rbegin()[3] << " ";
//		std::cout << thevect.rbegin()[4] << " ";
//		std::cout << thevect.rbegin()[5] << std::endl;
//	}
	return 0;
}
